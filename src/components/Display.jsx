...
const Display = () => {
  return (
    <section className='w-screen h-screen bg-white px-12 py-10 mobile-section mobile-section '>
    ...
    <video src={performance} muted autoPlay loop playsInline className='object-cover w-3/5 my-16 video-mobile'></video>
        </div>
    </section>
  )
}
