...
const Camera = () => {
    ...
    return (
        <section ref={container} className='w-screen h-100 px-12 relative mobile-section'>
            ...
            <div className='sticky top-0 h-screen w-screen overflow-hidden '>
                {images.map(({ src, scale, top, left, width, height }, index) => (
                    <motion.div key={index} className='w-full h-full absolute top-0 flex justify-center items-center' style={{ scale: (screenWidth > 690) ? scale : 1 }}>
